...
Building a data warehouse that is data engineering

## Objectives
Develop a modern data warehouse using SQL server to consolidate the data enabling the analytical reporting and infromed decision making
